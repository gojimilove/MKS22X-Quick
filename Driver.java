    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            try {
                ...
                int index = QuickSort.partition(test, start, end);
